...
func (rcv *Request) RequestType() RequestUnion {
...
func (rcv *Request) MutateRequestType(n RequestUnion) bool {
...
func RequestAddRequestType(builder *flatbuffers.Builder, requestType RequestUnion) {
